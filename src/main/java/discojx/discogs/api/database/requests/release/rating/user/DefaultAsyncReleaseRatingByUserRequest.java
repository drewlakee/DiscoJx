...
public class DefaultAsyncReleaseRatingByUserRequest implements AsyncReleaseRatingByUserRequest {
    ...
    public DefaultAsyncReleaseRatingByUserRequest(Builder builder) {
        this.client = builder.client;
        this.releaseId = builder.releaseId;
        this.username = builder.username;
    }

    public static class Builder implements AsyncReleaseRatingByUserRequestBuilder {
        ...
        @Override
        public AsyncReleaseRatingByUserRequestBuilder releaseId(long releaseId) {
            this.releaseId = releaseId;
            return this;
        }

        @Override
        public AsyncReleaseRatingByUserRequestBuilder username(String username) {
            this.username = username;
            return this;
        }

        @Override
        public AsyncReleaseRatingByUserRequest build() {
            return new DefaultAsyncReleaseRatingByUserRequest(this);
        }
    ...
    @Override
    public String toString() {
        return "DefaultAsyncReleaseRatingByUserRequest{" +
                "client=" + client +
                ", releaseId=" + releaseId +
                ", username='" + username + '\'' +
                '}';
    ...
    public boolean equals(Object o) {
        if (this == o) return true;
        if (o == null || getClass() != o.getClass()) return false;
        DefaultAsyncReleaseRatingByUserRequest that = (DefaultAsyncReleaseRatingByUserRequest) o;
