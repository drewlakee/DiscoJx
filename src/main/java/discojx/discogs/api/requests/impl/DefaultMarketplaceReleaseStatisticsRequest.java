...
public class DefaultMarketplaceReleaseStatisticsRequest extends AbstractRequest implements MarketplaceReleaseStatisticsRequest {
    ...
    public CompletableFuture<EntityResponseWrapper<MarketplaceReleaseStatistics>> executeAsync() {
        return CompletableFuture.supplyAsync(() -> {
            ...
            MarketplaceReleaseStatistics marketplaceReleaseStatistics;
            try {
                marketplaceReleaseStatistics = JsonUtils.DefaultObjectMapperHolder.mapper.readValue(response.getEntity().getContent(), MarketplaceReleaseStatistics.class);
            } catch (IOException e) {
